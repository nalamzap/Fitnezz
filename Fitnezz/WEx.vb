Public Class WEx
	...
	'Moving the form#############################################################
	Private Sub Mm(sender As Object, e As MouseEventArgs) Handles Me.MouseMove, Label31.MouseMove
		If MoDn = True Then
	...
	Private Sub Md(sender As Object, e As MouseEventArgs) Handles Me.MouseDown, Label31.MouseDown
		MoDn = True
	End Sub

	Private Sub Mu(sender As Object, e As MouseEventArgs) Handles Me.MouseUp, Label31.MouseUp
		MoDn = False
		xw = 0
		yw = 0
	End Sub
		...
		If x = 1 Then
			If ProgressBar1.Value = 2 Then
				...
				For Each cont In Controls
					Try
						If DirectCast(cont, Label).Text = Exs(y) Then
							With DirectCast(cont, Label)
					...
					Try
						If DirectCast(cont, Label).Text = Exs(y) Then
							...
							For Each contr In Controls
								Try
									If DirectCast(contr, Label).Text = Exs(y - 1) Then
										With DirectCast(contr, Label)
